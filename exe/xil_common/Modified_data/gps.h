...
extern "C" void record_gps() {
    ...
    drg->add_variable("rkt.dynamics._f[0]");
    drg->add_variable("rkt.dynamics._f[1]");
    drg->add_variable("rkt.dynamics._f[2]");
    drg->add_variable("rkt.dynamics._f[3]");
    drg->add_variable("rkt.dynamics._f[4]");
    drg->add_variable("rkt.dynamics._f[5]");
    drg->add_variable("rkt.dynamics._p_b1_ga[0]");
    drg->add_variable("rkt.dynamics._p_b1_ga[1]");
    drg->add_variable("rkt.dynamics._p_b1_ga[2]");
    drg->add_variable("rkt.dynamics._p_b1_be[0]");
    drg->add_variable("rkt.dynamics._p_b1_be[1]");
    drg->add_variable("rkt.dynamics._p_b1_be[2]");
    ...
    // drg->add_variable("rkt.propulsion._XCG[0]");
    // drg->add_variable("rkt.aerodynamics._XCP[0]");
    drg->add_variable("rkt.rcs._Q_RCS[0]");
    drg->add_variable("rkt.rcs._Q_RCS[1]");
    drg->add_variable("rkt.rcs._Q_RCS[2]");
    drg->add_variable("rkt.rcs._Q_RCS[3]");
    drg->add_variable("rkt.rcs._Q_RCS[4]");
    drg->add_variable("rkt.rcs._Q_RCS[5]");
