...
extern "C" void record_gps_slave() {
    ...
    //  drg->add_variable("fc.ins.liftoff");
     ...
     // drg->add_variable("fc.control._GAINFP[0]");
     // drg->add_variable("fc.control._GAINFP[1]");
     // drg->add_variable("fc.control._GAINFP[2]");
     // drg->add_variable("fc.control.zz");
     // drg->add_variable("fc.control.zzd");
     // drg->add_variable("fc.control.dla");
