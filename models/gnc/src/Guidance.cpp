...
arma::vec3 Guidance::guidance_ltg(double int_step, double time_ltg) {
  ...
  if (beco_flag && print_flag) {
    ...
    std::cout << " *** Boost engine cut-off time = " << time << " sec ***\n";
...
void Guidance::guidance_ltg_tgo(double &tgop, arma::mat &BURNTN,
                                ...
                                arma::mat BOTN, double delay_ignition,
                                double vgom, double amag1, double amin,
                                double time_ltg, int num_stages) {
  // local variables
  int i(0);
...
void Guidance::guidance_ltg_trate(
    arma::mat &ULAM, arma::mat &LAMD, arma::mat &RGO, int &ipas2_flag,
    arma::mat VGO, double s_igrl, double q_igrl, double j_over_l,
    double lamd_limit, double vgom, double time_ltg, double tgo, double tgop,
    arma::mat SDII, arma::mat SBIIC, arma::mat VBIIC, arma::mat RBIAS,
    arma::mat UD, arma::mat UY, arma::mat UZ, arma::mat &RGRAV) {
  //-------------------------------------------------------------------------
...
void Guidance::guidance_ltg_trate_rtgo(arma::mat &RGO, arma::mat &RGRAV,
                                       double tgo, double tgop, arma::mat SDII,
                                       arma::mat SBIIC, arma::mat VBIIC,
                                       arma::mat RBIAS, arma::mat ULAM,
...
void Guidance::guidance_ltg_pdct(arma::mat &SPII, arma::mat &VPII,
                                 arma::mat &RGRAV, arma::mat &RBIAS,
                                 arma::mat LAMD, arma::mat ULAM, double l_igrl,
  ...
  arma::mat RTHRUST =
      ULAM * (s_igrl - 0.5 * lmdsq * (p_igrl - j_over_l * (q_igrl + qprime))) +
...
void Guidance::guidance_ltg_crct(arma::mat &SDII, arma::mat &UD, arma::mat &UY,
                                 arma::mat &UZ, arma::mat &VMISS,
                                 arma::mat &VGO, double dbi_desired,
                                 double dvbi_desired, double thtvdx_desired,
