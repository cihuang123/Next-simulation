...
class TVC : public Dynamics {
 ...
 private:
  ...
  double ActOutput1; /* *o (r)  Store first actuator output value for trick data
                        record */
  double ActOutput2; /* *o (r)  Store second actuator output value for trick
                        data record */
  double ActOutput3; /* *o (r)  Store third actuator output value for trick data
                        record */
  double ActOutput4; /* *o (r)  Store fourth actuator output value for trick
                        data record */
